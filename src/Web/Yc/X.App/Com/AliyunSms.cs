...
namespace X.App.Com
{
    ...
    {
        private const string _endpoint = "https://1625487773132895.mns.cn-hangzhou.aliyuncs.com/"; // eg. http://1234567890123456.mns.cn-shenzhen.aliyuncs.com
        private const string _accessKeyId = "LTAIP8aKCv1LUo4P";
        private const string _secretAccessKey = "S0DiD9VFx5gC4fhnCKWy3wMONy3J7z";
